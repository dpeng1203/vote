<template>
  <div class="vote">
    ...
    <div class="btn">
      <van-button type="danger" @click="handleSubmit">提交评分</van-button>
    </div>
  </div>
</template>
          ...
          subList: [
            {
              ...
              vote: 20,
              desc: [
                "1.基于课程标准，切合学生实际，知识容量适中，难度符合学业质量水平要求，制定合适的教学目标",
                "2.教学核心围绕高考试题解题素养培养：如空间与分布信息获取、地理原理类理解、地理过程类解题、综合思维类解决四大核心能力",
                // "3.教学重难点突出，符合新课标育人导向",
                // "4.地理图文信息等教学资源科学严谨",
          ...
          subList: [
            {
              ...
              desc: [
                ...
                "3.展示学生对地理信息获取、地理原理表达、地理过程分析及综合思维的多角度辨析",
                // "4.学生表现出分析和整合技能",
              ],
              value: 0,
            },
            ...
            },
            {
              ...
              vote: 20,
              desc: [
                "1.时空分布描述：可对地理事象进行时空分布及特征类描述",
                "2.综合思维分析：能结合材料进行事象演绎、分析、归纳",
                "3.地理过程类：分析地理事物发展演化的阶段、环节、驱动力及时空变化规律",
                "4.地理原理类：理解地理核心原理，掌握原理内涵、核心要素、适用条件及要素间关联逻辑",
              ],
              value: 0,
            },
          ],
          ...
          subList: [
            {
              ...
              desc: [
                ...
                "2.学生体验：课堂气氛和谐融洽，学生自然出现笑声等情绪投入表现",
              ],
              value: 0,
            },
          ],
        },
        {
          ...
          subList: [
            ...
            },
            {
              ...
              vote: 10,
              desc: [
                "1.师生互动、生生互动有效，能处理好预设与生成的关系",
                "2.针对学生表现，教师进行完整、有层次的反馈，进行有效教学补救，实现“教—学—评—改”一体化",
              ],
              value: 0,
            },
          ],
